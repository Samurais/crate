...
public class SysNodeCheckerIntegrationTest extends SQLTransportIntegrationTest {
    ...
    @Override
    // TODO: This is for testing the ClusterNameInPathDataNodesSysCheck and should be removed once we migrate to ES 6.0
    ...
    public void testClusterNameInPathDataNodesSysCheck() throws Exception {
        ...
        assertTrue(description.contains(dirs.get(0)) || description.contains(dirs.get(1)));
